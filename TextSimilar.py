# code from https://stackoverflow.com/questions/8897593/similarity-between-two-text-documents
...
def cosine_sim(*args):
    tfidf = vect.fit_transform(list(args))
...
print(cosine_sim(test1, test2, test3))
# print(cosine_sim('a little bird', 'a little, ?birds.!!!!!!!', 'a little catboy'))
# print(cosine_sim('Trump berates a veteran', 'Romney disowns Trump after veteran comments', 'Obama calls Romney a Trump, Romney is insulted'))